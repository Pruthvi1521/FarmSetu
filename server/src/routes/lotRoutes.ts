...
import { createLot, getLots, getLotDetails, getOffersForLot, submitOffer, acceptOffer, cancelLot } from '../controllers/LotController';
...
router.get('/', getLots);
router.get('/:id/offers', authenticateToken, getOffersForLot);
