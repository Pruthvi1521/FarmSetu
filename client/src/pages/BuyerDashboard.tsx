...
// Isolated so its data-fetching only runs while this route is active.
...
// Uses nested <Routes> so URL is the single source of truth.
// Tab active state derived synchronously from useLocation() — no useEffect needed.
// This mirrors the FarmerDashboard pattern exactly.
...
export const BuyerDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      {/* ─── Content area — URL-driven via nested Routes ───────────────────────── */}
