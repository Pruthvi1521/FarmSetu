...
import { Sparkles, ArrowRight, Mic, CheckCircle2, AlertCircle } from 'lucide-react';
        ...
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">
              FarmSetu instantly matches your harvest to peak markets, prices, transport costs, and buyers.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div className="relative">
            <textarea
              ...
              className="w-full bg-slate-900/90 border border-slate-700/80 focus:border-emerald-500/80 rounded-xl p-4 text-white text-base sm:text-lg placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all resize-none shadow-inner"
            />
            <div className="absolute bottom-3 right-3 flex items-center space-x-2">
              <button
                type="button"
                title="Voice input simulation"
                onClick={() => setInputText('I have 2 tonnes of tomatoes, ready in 5 days')}
              ...
              <button
                ...
                className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 disabled:opacity-50 text-slate-950 font-semibold rounded-lg shadow-lg shadow-emerald-500/20 transition-all"
              >
                {isLoading ? (
                  <>
